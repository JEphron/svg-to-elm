...
{
	if (region.bk.aG === region.bG.aG)
	{
		return 'on line ' + region.bk.aG;
	}
	return 'on lines ' + region.bk.aG + ' through ' + region.bG.aG;
}
...
var author$project$Main$problemToString = function (problem) {
	switch (problem.$) {
		case 0:
...
var author$project$Main$deadEndToString = function (deadEnd) {
	return author$project$Main$problemToString(deadEnd.dd) + (' (row: ' + (elm$core$String$fromInt(deadEnd.dg) + (', col: ' + (elm$core$String$fromInt(deadEnd.cG) + ')'))));
};
...
var author$project$Main$workingDeadEndsToString = function (deadEnds) {
	return A2(
		elm$core$String$join,
		'\n',
		A2(elm$core$List$map, author$project$Main$deadEndToString, deadEnds));
};
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cG: col, cH: contextStack, dd: problem, dg: row};
	});
...
var elm$parser$Parser$Advanced$chompUntil = function (_n0) {
	...
	var expecting = _n0.b;
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$findSubString, str, s.b, s.dg, s.cG, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{cG: newCol, f: s.f, g: s.g, b: newOffset, dg: newRow, a: s.a});
	};
};
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			elm$parser$Parser$Advanced$AddRight,
			elm$parser$Parser$Advanced$Empty,
			A4(elm$parser$Parser$Advanced$DeadEnd, s.dg, s.cG, x, s.f));
	});
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.b, s.dg, s.cG, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var author$project$ParseSvg$inclusiveChompUntil = function (s) {
	return A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$chompUntil(s),
		elm$parser$Parser$symbol(s));
};
var author$project$ParseSvg$declarationP = A2(
	elm$parser$Parser$ignorer,
	elm$parser$Parser$symbol('<?xml'),
	author$project$ParseSvg$inclusiveChompUntil('?>'));
var author$project$ParseSvg$doctypeP = A2(
	elm$parser$Parser$ignorer,
	elm$parser$Parser$symbol('<!DOCTYPE'),
	author$project$ParseSvg$inclusiveChompUntil('>'));
var author$project$ParseSvg$SvgNode = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cG: col, f: s0.f, g: s0.g, b: offset, dg: row, a: s0.a});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.dg, s.cG, s);
	};
};
...
var author$project$ParseSvg$attrNameP = function () {
	...
	return elm$parser$Parser$getChompedString(
		A2(
			...
			elm$parser$Parser$chompWhile(isNameChar)));
}();
var author$project$ParseSvg$quoteP = elm$parser$Parser$symbol('\"');
...
var author$project$ParseSvg$quotedStringP = function () {
	var isInnerChar = function (c) {
		return c !== '\"';
	};
	return A2(
		...
		A2(
			...
			author$project$ParseSvg$quoteP),
		A2(
			elm$parser$Parser$ignorer,
			elm$parser$Parser$getChompedString(
				A2(
					elm$parser$Parser$ignorer,
					elm$parser$Parser$succeed(0),
					elm$parser$Parser$chompWhile(isInnerChar))),
			author$project$ParseSvg$quoteP));
}();
...
var author$project$ParseSvg$attrP = A2(
	elm$parser$Parser$keeper,
	A2(
		elm$parser$Parser$keeper,
		...
		A2(
			elm$parser$Parser$ignorer,
			author$project$ParseSvg$attrNameP,
			elm$parser$Parser$symbol('='))),
	author$project$ParseSvg$quotedStringP);
var author$project$ParseSvg$whitespaceP = elm$parser$Parser$chompWhile(
	function (c) {
		return (c === ' ') || ((c === '\n') || ((c === '\u000d') || (c === '\t')));
	});
...
var author$project$ParseSvg$attrsP = function () {
		...
		return elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					...
					A2(elm$parser$Parser$ignorer, author$project$ParseSvg$attrP, author$project$ParseSvg$whitespaceP)),
					A2(
					elm$parser$Parser$map,
					function (_n0) {
...
var author$project$ParseSvg$closingTagP = function (attrName) {
	return elm$parser$Parser$symbol('</' + (attrName + '>'));
};
var author$project$ParseSvg$commentP = A2(
	elm$parser$Parser$ignorer,
	A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$succeed(0),
...
var author$project$ParseSvg$fail = function (why) {
	return elm$parser$Parser$andThen(
		elm$core$Basics$always(
			elm$parser$Parser$problem(why)));
};
var author$project$ParseSvg$noChildrenP = A2(
	elm$parser$Parser$ignorer,
	elm$parser$Parser$succeed(_List_Nil),
	elm$parser$Parser$symbol('/>'));
var author$project$ParseSvg$TextNode = function (a) {
	return {$: 1, a: a};
};
var author$project$ParseSvg$textContentP = elm$parser$Parser$getChompedString(
	A2(
		elm$parser$Parser$ignorer,
		elm$parser$Parser$succeed(0),
...
var author$project$ParseSvg$textChildrenP = A2(
	elm$parser$Parser$keeper,
	elm$parser$Parser$succeed(
		function (string) {
			return elm$core$String$isEmpty(string) ? _List_Nil : _List_fromArray(
				[
					author$project$ParseSvg$TextNode(string)
				]);
		}),
	author$project$ParseSvg$textContentP);
...
var author$project$ParseSvg$childrenP = function (attrName) {
	return A2(
		elm$parser$Parser$keeper,
		A2(
			elm$parser$Parser$keeper,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							elm$parser$Parser$symbol('>')),
						author$project$ParseSvg$whitespaceP),
					elm$parser$Parser$oneOf(
						_List_fromArray(
							[
								elm$parser$Parser$backtrackable(author$project$ParseSvg$commentP),
								elm$parser$Parser$succeed(0)
							]))),
				author$project$ParseSvg$whitespaceP),
			A2(elm$parser$Parser$ignorer, author$project$ParseSvg$textChildrenP, author$project$ParseSvg$whitespaceP)),
		A2(
			elm$parser$Parser$ignorer,
			A2(
				elm$parser$Parser$ignorer,
				A2(
					...
					A2(
						elm$parser$Parser$ignorer,
						author$project$ParseSvg$cyclic$svgChildrenP(),
						author$project$ParseSvg$whitespaceP),
					elm$parser$Parser$oneOf(
						_List_fromArray(
							[
			...
			elm$parser$Parser$backtrackable(
				author$project$ParseSvg$closingTagP(attrName))));
};
function author$project$ParseSvg$cyclic$svgChildrenP() {
	var appendHelper = F3(
		function (revSvgs, svg, txtNode) {
			return elm$parser$Parser$Loop(
				_Utils_ap(
					txtNode,
					A2(elm$core$List$cons, svg, revSvgs)));
		});
	var helper = function (revStmts) {
		return elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					...
					A2(
						...
						A2(
							elm$parser$Parser$keeper,
							elm$parser$Parser$succeed(
								appendHelper(revStmts)),
							A2(
								elm$parser$Parser$ignorer,
								author$project$ParseSvg$cyclic$svgP(),
								author$project$ParseSvg$whitespaceP)),
						elm$parser$Parser$oneOf(
							_List_fromArray(
								[
									author$project$ParseSvg$textChildrenP,
									elm$parser$Parser$succeed(_List_Nil)
								])))),
					A2(
					elm$parser$Parser$map,
...
function author$project$ParseSvg$cyclic$svgP() {
	var children = function (attrName) {
		return elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					elm$parser$Parser$backtrackable(author$project$ParseSvg$noChildrenP),
					author$project$ParseSvg$childrenP(attrName)
				]));
	};
	var attrsAndChildren = function (attrName) {
		return A2(
			elm$parser$Parser$keeper,
			A2(
				elm$parser$Parser$keeper,
				A2(
					elm$parser$Parser$ignorer,
					elm$parser$Parser$succeed(
						author$project$ParseSvg$SvgNode(attrName)),
					author$project$ParseSvg$whitespaceP),
				A2(elm$parser$Parser$ignorer, author$project$ParseSvg$attrsP, author$project$ParseSvg$whitespaceP)),
			children(attrName));
	};
	var name = A2(
	...
	return A2(
		...
		elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					A2(
					author$project$ParseSvg$fail,
					'Mismatched closing tag?',
					elm$parser$Parser$symbol('/')),
					name
				])));
}
var author$project$ParseSvg$svgChildrenP = author$project$ParseSvg$cyclic$svgChildrenP();
author$project$ParseSvg$cyclic$svgChildrenP = function () {
	return author$project$ParseSvg$svgChildrenP;
};
var author$project$ParseSvg$svgP = author$project$ParseSvg$cyclic$svgP();
author$project$ParseSvg$cyclic$svgP = function () {
	return author$project$ParseSvg$svgP;
};
var author$project$ParseSvg$svgDocumentP = A2(
	elm$parser$Parser$keeper,
	A2(
		elm$parser$Parser$ignorer,
		A2(
			...
			A2(
				...
				A2(
					...
					elm$parser$Parser$oneOf(
						_List_fromArray(
							[
								elm$parser$Parser$backtrackable(author$project$ParseSvg$declarationP),
								elm$parser$Parser$succeed(0)
							]))),
				author$project$ParseSvg$whitespaceP),
			elm$parser$Parser$oneOf(
				_List_fromArray(
					[
						elm$parser$Parser$backtrackable(author$project$ParseSvg$doctypeP),
						elm$parser$Parser$succeed(0)
					]))),
		author$project$ParseSvg$whitespaceP),
	author$project$ParseSvg$svgP);
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cG: col, dd: problem, dg: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.dg, p.cG, p.dd);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{cG: 1, f: _List_Nil, g: 1, b: 0, dg: 1, a: src});
		if (!_n1.$) {
			var value = _n1.b;
...
var author$project$ParseSvg$convertSvgToElm = function (svg) {
	return A2(elm$parser$Parser$run, author$project$ParseSvg$svgDocumentP, svg);
};
...
var author$project$SvgToElm$ambiguousNames = A2(elm$core$Set$intersect, author$project$SvgToElm$knownAttrs, author$project$SvgToElm$knownNodes);
var elm$core$Set$member = F2(
	function (key, _n0) {
		var dict = _n0;
		return A2(elm$core$Dict$member, key, dict);
	});
var author$project$SvgToElm$disambiguate = F2(
	function (name, prefix) {
		return A2(elm$core$Set$member, name, author$project$SvgToElm$ambiguousNames) ? (prefix + ('.' + name)) : name;
	});
var elm$core$Char$toUpper = _Char_toUpper;
var elm$core$String$cons = _String_cons;
var elm$core$String$uncons = _String_uncons;
var author$project$SvgToElm$capitalize = function (str) {
...
var author$project$SvgToElm$kebabToCamel = function (name) {
	var preparedName = A2(
		elm$core$String$split,
		'-',
		A3(elm$core$String$replace, ':', '-', name));
	if (preparedName.b) {
		var head = preparedName.a;
		var tail = preparedName.b;
		return _Utils_ap(
			head,
			A2(
				elm$core$String$join,
				'',
				A2(elm$core$List$map, author$project$SvgToElm$capitalize, tail)));
	} else {
		return name;
	}
};
var elm$core$String$contains = _String_contains;
var author$project$SvgToElm$quote = function (value) {
	return A2(elm$core$String$contains, '\n', value) ? ('\"\"\"' + (value + '\"\"\"')) : ('\"' + (value + '\"'));
};
var author$project$SvgToElm$attrToString = function (_n0) {
	var name = _n0.a;
	var value = _n0.b;
	var camelized = author$project$SvgToElm$kebabToCamel(name);
	return A2(elm$core$Set$member, camelized, author$project$SvgToElm$knownAttrs) ? elm$core$Maybe$Just(
		A2(author$project$SvgToElm$disambiguate, camelized, 'Attributes') + (' ' + author$project$SvgToElm$quote(value))) : elm$core$Maybe$Nothing;
};
...
var author$project$SvgToElm$attrsToStr = function (attrs) {
	return A2(
		elm$core$String$join,
		', ',
		A2(elm$core$List$filterMap, author$project$SvgToElm$attrToString, attrs));
};
var author$project$SvgToElm$nodeNameToElm = function (name) {
	if (name === 'text') {
		return 'text_';
	} else {
		var other = name;
		return A2(
			elm$core$Set$member,
			author$project$SvgToElm$kebabToCamel(name),
			author$project$SvgToElm$knownNodes) ? A2(
			author$project$SvgToElm$disambiguate,
			author$project$SvgToElm$kebabToCamel(name),
			'Svg') : ('node ' + author$project$SvgToElm$quote(name));
	}
};
var author$project$SvgToElm$astToElm = function (node) {
	if (!node.$) {
		var name = node.a;
		var attrs = node.b;
		var children = node.c;
		return author$project$SvgToElm$nodeNameToElm(name) + (' [' + (author$project$SvgToElm$attrsToStr(attrs) + ('] [' + (author$project$SvgToElm$childrenToString(children) + ']'))));
	} else {
		var text = node.a;
		return 'text ' + author$project$SvgToElm$quote(text);
	}
};
var author$project$SvgToElm$childrenToString = function (children) {
	return A2(
		elm$core$String$join,
		', ',
		A2(elm$core$List$map, author$project$SvgToElm$astToElm, children));
};
var author$project$SvgToElm$moduleHeader = 'module MySvg exposing (view)\nimport Svg exposing (..)\nimport Svg.Attributes as Attributes exposing (..)\n\nview = ';
var author$project$SvgToElm$svgToElm = function (node) {
	return _Utils_ap(
		author$project$SvgToElm$moduleHeader,
		author$project$SvgToElm$astToElm(node));
};
var author$project$Main$toElmCode = function (content) {
	var _n0 = author$project$ParseSvg$convertSvgToElm(content);
	if (_n0.$ === 1) {
		var deadEnds = _n0.a;
		return 'parse error: \n' + author$project$Main$workingDeadEndsToString(deadEnds);
	} else {
		var result = _n0.a;
		return author$project$SvgToElm$svgToElm(result);
	}
};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{
			aC: author$project$Main$toElmCode(author$project$Main$initSvg),
			aN: author$project$Main$initSvg
		},
		...
		if (!msg.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						aC: author$project$Main$toElmCode(content),
						aN: content
					}),
				elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						aC: author$project$Main$toElmCode(model.aN)
					}),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$SvgCodeChange = function (a) {
	return {$: 0, a: a};
};
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bC: elm$core$Maybe$Nothing, bR: _List_Nil, b0: _List_Nil, cj: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	var charset = _n0.bC;
	var imports = _n0.bR;
	var namespaces = _n0.b0;
	var snippets = _n0.cj;
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bC: charset, cJ: declarations, bR: imports, b0: namespaces};
};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return elm$core$String$isEmpty(record.cI) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3(elm$core$Dict$insert, record.c$, record.cI, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bC: charset, cJ: finalDeclarations, bR: imports, b0: namespaces};
};
...
var author$project$Main$contents = rtfeldman$elm_css$Html$Styled$div(
	_List_fromArray(
		[
...
var author$project$Main$justifyContent = rtfeldman$elm_css$Css$property('justify-content');
		...
		[
			...
			_List_fromArray(
				[
					...
					author$project$Main$justifyContent('center')
				]))
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$href('https://github.com/JEphron/svg-to-elm')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Html$Styled$Attributes$src('assets/github.png')
						]),
					_List_Nil)
				]))
		]));
...
var rtfeldman$elm_css$Css$lighter = {O: 0, J: 'lighter'};
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$hex('#1293D8')),
							rtfeldman$elm_css$Css$width(
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Css$displayFlex,
									rtfeldman$elm_css$Css$alignItems(rtfeldman$elm_css$Css$center),
									author$project$Main$justifyContent('space-evenly'),
									rtfeldman$elm_css$Css$width(
									rtfeldman$elm_css$Css$pct(100))
								]))
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$text('svg')
								])),
...
var rtfeldman$elm_css$Css$vertical = {a3: 0, J: 'vertical'};
var author$project$Main$textAreaStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var rtfeldman$elm_css$Css$row = {bc: 0, aD: 0, J: 'row'};
var rtfeldman$elm_css$Css$column = _Utils_update(
	rtfeldman$elm_css$Css$row,
	{J: 'column'});
var rtfeldman$elm_css$Css$flexDirection = rtfeldman$elm_css$Css$prop1('flex-direction');
var author$project$Main$textAreaWrapperStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$pct(100)),
...
var author$project$Main$inputBox = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[author$project$Main$textAreaWrapperStyle]))
				]),
			_Utils_ap(
				children,
				_List_fromArray(
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[author$project$Main$textAreaStyle]))
								])),
						_List_Nil)
					])));
	});
var author$project$Main$wrapper = rtfeldman$elm_css$Html$Styled$div(
	_List_fromArray(
		[
			rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											rtfeldman$elm_css$Html$Styled$Attributes$value(model.aN),
											rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Main$SvgCodeChange)
										]),
									_List_fromArray(
										[
											A2(
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bL: fragment, bQ: host, b3: path, b5: port_, b8: protocol, b9: query};
	});
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		...
		dj: elm$core$Basics$always(elm$core$Platform$Sub$none),
